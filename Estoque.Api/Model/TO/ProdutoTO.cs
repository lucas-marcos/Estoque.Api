...
public class ProdutoTOValidator : AbstractValidator<ProdutoTO>
{
    ...
    {
        RuleFor(a => a.Nome).NotNull().NotEmpty().WithMessage("É necessário informar um nome para o produto");
        ...
        RuleFor(a => a.CodigoDeBarra).NotNull().NotEmpty()
            .WithMessage("É necessário informar o código de barras do produto");
    }
}